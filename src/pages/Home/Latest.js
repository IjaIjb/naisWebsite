        ...
        <div className="w-full md:max-w-[1000px] ">
          <div className="w-full  pt-[100px] pb-[70px] px-[15px] ">
            <div className="flex items-center justify-between pb-5">
              <h4 className="text-[#3a3a3a] text-[33px] md:text-[42px] font-[600]">
                Latest News
              </h4>
            ...
            <div className="grid md:grid-cols-3 gap-[30px]">
              <div className="bg-white shadow-md">
                ...
                <a
                  href=""
                  className="text-[#444444] text-[16px]  font-[400] hover:underline"
                >
                  NAIS Signs Partnership Agreement with Rana Energy, Targets
                  18500 Megawatts of Clean Energy for 5,000 Homes, 1000 Jobs
                </a>
              </div>
              ...
              <div className="bg-white shadow-md">
                ...
                <a
                  ...
                  className="text-[#444444] text-[16px]  font-[400] hover:underline"
                >
                  NAIS Graduates 113 Participants
                </a>
              </div>
